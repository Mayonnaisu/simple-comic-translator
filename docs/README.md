...
2. Gemini itself is prone to throwing [model-overloaded error](https://github.com/google-gemini/gemini-cli/issues/4360) & returning `None` or incomplete response and response with messed-up format. When those happens, just retry it.
